...
const ::_pbi::TcParseTable<3, 5, 1, 0, 2> Player::_table_ = {
  {
    ...
    // float position_x = 2;
    {::_pbi::TcParser::FastF32S1,
     {21, 63, 0, PROTOBUF_FIELD_OFFSET(Player, _impl_.position_x_)}},
    // float position_y = 3;
    {::_pbi::TcParser::FastF32S1,
     {29, 63, 0, PROTOBUF_FIELD_OFFSET(Player, _impl_.position_y_)}},
    // double player_attack_damage = 4;
    {::_pbi::TcParser::FastF64S1,
     {33, 63, 0, PROTOBUF_FIELD_OFFSET(Player, _impl_.player_attack_damage_)}},
    // repeated .comm.Item items = 5;
    {::_pbi::TcParser::FastMtR1,
     {42, 63, 0, PROTOBUF_FIELD_OFFSET(Player, _impl_.items_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
        ...
        ::uint8_t* Player::_InternalSerialize(
          ...
          if (::absl::bit_cast<::uint64_t>(this_._internal_player_attack_damage()) != 0) {
            ...
            target = ::_pbi::WireFormatLite::WriteDoubleToArray(
                4, this_._internal_player_attack_damage(), target);
          }
