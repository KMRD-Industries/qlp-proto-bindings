...
func (x *Enemy) GetDamage() float32 {
	if x != nil {
		return x.Damage
	}
	return 0
...
type Player struct {
	...
	X                  float32 `protobuf:"fixed32,2,opt,name=x,proto3" json:"x,omitempty"`
	Y                  float32 `protobuf:"fixed32,3,opt,name=y,proto3" json:"y,omitempty"`
	PlayerAttackDamage float32 `protobuf:"fixed32,4,opt,name=playerAttackDamage,proto3" json:"playerAttackDamage,omitempty"`
}
...
func (x *Player) GetPlayerAttackDamage() float32 {
	if x != nil {
...
func (x *TextureData) GetTileId() int32 {
	if x != nil {
		return x.TileId
	}
	return 0
...
var file_comm_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x68, 0x70, 0x18, 0x06, 0x20, 0x01, 0x28, 0x02, 0x52, 0x02,
	0x68, 0x70, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x61, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x02, 0x52, 0x06, 0x64, 0x61, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x33, 0x0a, 0x0b, 0x74, 0x65,
	...
	0x44, 0x61, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x12, 0x70, 0x6c,
